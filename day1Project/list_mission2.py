...
#     각 학생 점수를 리스트(sungjuk_list1)에 순서대로 저장 처리함
...
# kor1 = float(input('국어 : '))
# eng1 = float(input('영어 : '))
# math1 = float(input('수학 : '))
# sum1 = kor1 + eng1 + math1
# avg1 = sum1 / 3
#
# sungjuk_list1.append(kor1)
# sungjuk_list1.append(eng1)
# sungjuk_list1.append(math1)
# sungjuk_list1.append(sum1)
# sungjuk_list1.append(avg1)
#
# sungjuk_list2 = []
# kor2 = float(input('국어 : '))
# eng2 = float(input('영어 : '))
# math2 = float(input('수학 : '))
# sum2 = kor2 + eng2 + math2
# avg2 = sum2 / 3
#
# sungjuk_list2.append(kor1)
# sungjuk_list2.append(eng1)
# sungjuk_list2.append(math1)
# sungjuk_list2.append(sum1)
# sungjuk_list2.append(avg1)
#
# print('국어 : {:2.1f}, 수학 : {:2.1f}, 영어 : {:2.1f}, 평균 {:0.1f}, 총점 : {:2.1f}'.format(sungjuk_list1[0], \
#                                                                                   sungjuk_list1[1], sungjuk_list1[2], sungjuk_list1[3], \
#                                                                                   sungjuk_list1[4]))
#
# print('국어 : {:2.1f}, 수학 : {:2.1f}, 영어 : {:2.1f}, 평균 {:0.1f}, 총점 : {:2.1f}'.format(sungjuk_list2[0], \
#                                                                                   sungjuk_list2[1], sungjuk_list2[2], sungjuk_list2[3], \
#                                                                                   sungjuk_list2[4]))
#
# print('전체 총점 : {:10.2f}, 전체 평균 {:10.2f}'.format((sum1 + sum2),(sum1 + sum2) / 2 ))
