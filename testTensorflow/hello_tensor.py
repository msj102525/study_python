...
print("학습용 출력 데이터 모양 : ", X_test.shape)
print("평가용 입력 데이터 모양 : ", Y_train.shape)
...
print('첫번째 학습용 출력 데이터 확인 : ', Y_train[0])

# 이미지 데이터 [0, 1] 스케일링 : 연산할 각 픽셀의 값의 범위를 축소시킴 [0, 255] => [0, 1] 로 바꿈
...
answer= tf.argmax(pred, axis=1) # 가장 큰 값의 인덱스를 리턴함
