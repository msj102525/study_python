...
# 이 부분에서는 게임을 어떻게 훈련할지에 대한 다양한 설정 값을 정해요.
#
# "env_name": ENV_NAME
# 우리가 사용할 게임 이름이에요.
#
# "max_num_episodes": 1_500
# 게임을 최대 1,500번 플레이하며 훈련할 거예요.
#
# "batch_size": 32
# 한 번에 32개의 경험을 사용해 훈련할 거예요.
#
# "learning_rate": 0.0005
# 우리 인공지능이 배우는 속도예요. 너무 빠르면 헷갈리고, 너무 느리면 시간이 오래 걸려요.
#
# "gamma": 0.99
# 미래의 보상을 얼마나 중요하게 생각할지 정해요. 0.99면 미래 보상도 거의 현재 보상만큼 중요하게 생각해요.
#
# "steps_between_train": 1
# 한 번 훈련한 후 몇 번의 게임 스텝을 진행할지 정해요. 여기서는 매번 스텝마다 훈련해요.
#
# "target_sync_step_interval": 500
# 500번 스텝마다 인공지능 모델을 최신 상태로 맞출 거예요.
#
# "replay_buffer_size": 300,000
# 인공지능이 기억할 수 있는 경험의 최대 개수예요.
#
# "epsilon_start": 0.95
# 처음에는 95% 확률로 랜덤한 행동을 해볼 거예요.
#
# "epsilon_end": 0.01
# 나중에는 1% 확률로만 랜덤한 행동을 해볼 거예요.
#
# "epsilon_final_scheduled_percent": 0.75
# 전체 훈련의 75%를 지났을 때 epsilon이 0.01이 될 거예요.
#
# "print_episode_interval": 10
# 10번 게임할 때마다 결과를 출력할 거예요.
#
# "train_num_episodes_before_next_test": 50
# 50번 게임할 때마다 인공지능을 테스트할 거예요.
#
# "validation_num_episodes": 3
# 테스트할 때 3번 게임을 해볼 거예요.
#
# "episode_reward_avg_solved": 200
# 테스트할 때 평균 점수가 200점을 넘으면 훈련을 멈출 거예요.
# 여기 수정
def main():
